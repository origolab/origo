...
/// Sapling provides a mechanism to allow the efficient creation of diversified payment addresses
/// with the same spending authority.
/// A group of such addresses shares the same full viewing key and incoming viewing key ,
/// and so creating as many unlinkable addresses as needed does not increase the cost
/// of scanning the block chain for relevant transactions
#[derive(Clone, Copy, Debug, PartialEq)]
...
impl Copy for ExtendedSpendingKey {}
