...
impl fmt::Display for BlockError {
	fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
		...
		let msg = match *self {
			...
			InvalidSolution => "Solution is invalid .".into(),
		};
...
error_chain! {
	...
	errors {
		...
		#[doc = "The value of the nonce or solution is invalid."]
		PowInvalid {
			description("The value of the nonce or solution is invalid.")
			display("The value of the nonce or solution is invalid.")
		}
