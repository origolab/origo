...
/// Create a new Origo Medietas chain spec.
pub fn new_medietas<'a, T: Into<SpecParams<'a>>>(params: T) -> Spec {
	load(params.into(), include_bytes!("../../res/ethereum/medietas.json"))
}

/// Create a new Origo Medietas test-net chain spec.
pub fn new_medietatis<'a, T: Into<SpecParams<'a>>>(params: T) -> Spec {
	load(params.into(), include_bytes!("../../res/ethereum/medietas_testnet.json"))
}
...
/// Create a new reward test spec.
pub fn new_reward_test() -> Spec { load(None, include_bytes!("../../res/ethereum/reward.json")) }

/// Create a new era rewards test spec.
pub fn new_era_reward_test() -> Spec { load(None, include_bytes!("../../res/ethereum/era_rewards.json")) }
...
mod tests {
	...
	fn morden() {
		...
		assert_eq!(view!(BlockView, &genesis).header_view().hash(), "b1681215e72e8482ad19051027894362d2405369fd79b8627b1fc8375564ce4f".into());
	...
	fn frontier() {
		...
		assert_eq!(view!(BlockView, &genesis).header_view().hash(), "2f2a0c791d753ce19929eb22f8f5e42db3fb0ce25302ccf5582ca6fd8eccda44".into());
