...
impl From<ethjson::spec::Params> for CommonParams {
	fn from(p: ethjson::spec::Params) -> Self {
		let reward_config = RewardConfig {
			total_reward: p.total_reward.map_or(U256::from_str("c7272221823c0be1400000").unwrap(), Into::into),
			block_count_each_era: p.block_count_each_era.map_or(2000000, Into::into),
			production_rate: p.production_rate.map_or(50, Into::into),
...
impl Spec {
	...
	fn engine(
		...
		match engine_spec {
			...
			ethjson::spec::Engine::Ethash(ethash) => Arc::new(::ethereum::Ethash::new( ethash.params.into(), machine)),
...
mod tests {
	...
	fn test_chain() {
		...
		assert_eq!(
			...
			"b1681215e72e8482ad19051027894362d2405369fd79b8627b1fc8375564ce4f".into()
		);
	}
