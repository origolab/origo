...
impl Block {
	...
	pub fn parent_hash(&self) -> Option<&hash::H256> {
		match self.header{
			Some(ref header)=> {
				let ph = &header.parent_hash;
				Some(ph)
			},
			None => None,
		}
	...
	fn block_deserialization() {
		let s = r#"{
			"blockHeader" : {
				...
				"solution" : "13735ab4156c9b36327224d92e1692fab8fc362f8e0f868c94d421848ef7cd06",
				"nonce" : "000000000000000000000000000000000000000000000000931dcc53e5edc514",
				"number" : "0x01",
