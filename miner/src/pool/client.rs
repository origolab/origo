...
pub trait Client: fmt::Debug + Sync {
	...
	/// Verify the basic requirements for the private transaction.
...
/// Client that provides information about the existence of nullifier in blockchain.
pub trait NullifierClient: fmt::Debug + Sync {
	/// If this nullifier appeared in other transactions.
