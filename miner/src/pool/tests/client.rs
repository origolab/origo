...
impl Default for TestClient {
	fn default() -> Self {
		TestClient {
			...
			account_details: AccountDetails {
				nonce: 123.into(),
				balance: 63_100_000_000u64.into(),
				is_local: false,
			},
...
impl TestClient {
	...
	pub fn with_nullifier(mut self, nullifiers: Vec<U256>) -> Self {
		self.nullifier_set = HashSet::from_iter(nullifiers.iter().cloned());
		self
	}
...
impl pool::client::NullifierClient for TestClient {
