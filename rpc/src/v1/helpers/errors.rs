...
mod codes {
	...
	pub const PRIVATE_TX_ERROR: i64 = -32081;
}
...
// TODO(Xin): Include more detailed error message.
pub fn private_tx_error(e: String) -> Error {
	Error {
		code: ErrorCode::ServerError(codes::PRIVATE_TX_ERROR),
		message: String::from("Transaction builder failed.") + &e,
		data: None,
	}
}
