...
use ethereum_types::{Address, H160, H256, H512, U64, U256};
	...
	U: UpdateService + 'static,
{
	...
	fn submit_work_detail(&self, nonce: H256, pow_hash: H512, solution:Bytes ) -> Result<H256> {
		helpers::submit_work_detail(&self.client, &self.miner, nonce, pow_hash, solution)
	}
