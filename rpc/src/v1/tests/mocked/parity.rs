...
impl Dependencies {
	pub fn new() -> Self {
		Dependencies {
			...
			ws_address: Some("127.0.0.1:6623".into()),
		}
	}
...
fn rpc_parity_net_port() {
	...
	let response = r#"{"jsonrpc":"2.0","result":26622,"id":1}"#;
...
fn rpc_parity_rpc_settings() {
	...
	let response = r#"{"jsonrpc":"2.0","result":{"enabled":true,"interface":"all","port":6622},"id":1}"#;
...
fn rpc_parity_ws_address() {
	...
	let response1 = r#"{"jsonrpc":"2.0","result":"127.0.0.1:6623","id":1}"#;
