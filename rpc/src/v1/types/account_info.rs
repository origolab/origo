...
use ethereum_types::{Public, Address, H160, H256, U64, U256};
use v1::types::Bytes;
...
pub struct UnspentNote {
	...
	/// joinsplit index 
	pub jsindex: U64,
	/// output index of the joinsplit
	pub jsoutindex: U64,
	/// output index
	pub outindex: U64,
	/// number of confirmations
	pub confirmations: U64,
	/// True if note can be spent by wallet, 
	/// false if note has zero confirmations, false if address is watchonly
	pub spendable: bool,
	/// shielded address
	pub address: String,
	...
	pub memo: String,
	/// true if the address received the note is also in the sending addresses
	pub change: bool
}
